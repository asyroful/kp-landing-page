...
const AccordionContent = ({ isOpen, index, service, onClick }) => (
  <motion.div
    onClick={onClick}
    className={`overflow-hidden ${isOpen ? "cursor-pointer py-3 lg:py-6" : ""} bg-[#1A1A1A] rounded-b-xl lg:rounded-lg px-3 lg:px-6 pt-0 mb-6`}
    initial={false}
...
const ServiceSection = () => {
  ...
  return (
    <section id="services" ref={ref} className="pt-10 pb-20 bg-[#121212] scroll-mt-24">
